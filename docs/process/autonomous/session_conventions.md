...
A transição para **`✅ Implementado`** **não é responsabilidade da RTE deste milestone** — é executada pela Cleanup skill no **fold-in do dispatch seguinte** (`dispatch.md` §4.5), após o merge da PR. Detalhes em [`docs/process/refinement/epic_completion.md`](../refinement/epic_completion.md).
