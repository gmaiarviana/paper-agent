...
1. **`docs/interface/web.md`** - Documento principal de especificação da interface. Precisa de atualizações extensivas em múltiplas seções.
...
1. **Prioridade 1**: Atualizar `docs/interface/web.md` completamente - é a especificação técnica principal
