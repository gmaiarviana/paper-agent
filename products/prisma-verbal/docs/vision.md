...
> Para como sistema processa texto (exemplo Sapiens), consulte `docs/core/examples/text_processing.md`.
...
- `docs/core/examples/text_processing.md` - Exemplo concreto de processamento
